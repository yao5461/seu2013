...
#include "NaoHetero1.h"

namespace robot { 
  namespace humanoid {

        NaoHetero1::NaoHetero1()
            :Humanoid("#1rsg/agent/nao/nao.rsg")
        {
            init();
        }
        ...
        bool NaoHetero1::legInverseKinematics(bool isLeft,
        ...
        bool NaoHetero1::legIK(bool isLeft,
                        const TransMatrixf& torsoMat,
                        const TransMatrixf& footMat,
        ...
        bool NaoHetero1::legIK2(bool isLeft,
                         const TransMatrixf& torsoMat,
                         const TransMatrixf& footMat,
                         std::map<unsigned int, seumath::AngDeg>& angles) const
        {
        ...
        bool NaoHetero1::inverseHip(boost::shared_ptr<const Bone> hip1,
