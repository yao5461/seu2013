...
#include "NaoHetero2.h"

namespace robot { 
  namespace humanoid {

        NaoHetero2::NaoHetero2()
            :Humanoid("#2rsg/agent/nao/nao.rsg")
        {
            init();
        }
	    ...
	    cout<<"thighLength: "<<mThighLength<<"\tshankLength: "<<mShankLength<<endl;
        }

        bool NaoHetero2::legInverseKinematics(bool isLeft,
                                  const TransMatrixf& torsoMat,
                                  const TransMatrixf& footMat,
                                  std::map<unsigned int, seumath::AngDeg>& angles) const
        {
        ...
        bool NaoHetero2::legIK(bool isLeft,
                        const TransMatrixf& torsoMat,
                        const TransMatrixf& footMat,
                        std::map<unsigned int, seumath::AngDeg>& angles,
                        int count) const
        {   
            count--;
            if ( count < 0 ){
        ...
        bool NaoHetero2::legIK2(bool isLeft,
                         const TransMatrixf& torsoMat,
                         const TransMatrixf& footMat,
                         std::map<unsigned int, seumath::AngDeg>& angles) const
        {
        ...
        bool NaoHetero2::inverseHip(boost::shared_ptr<const Bone> hip1,
