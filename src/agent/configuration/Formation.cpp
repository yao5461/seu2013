...
void Formation::setupStrPlayerTypeMap()
{
	...
	mStrPlayerTypeMap["PT_DEFENDER_RIGHT"] 		= PT_DEFENDER_RIGHT;
	mStrPlayerTypeMap["PT_DEFENDER_RIGHT_WING"] 	= PT_DEFENDER_RIGHT_WING;
	mStrPlayerTypeMap["PT_DEFENDER_LEFT_WING"] 	= PT_DEFENDER_LEFT_WING;
	mStrPlayerTypeMap["PT_DEFENDER_LEFT"] 		= PT_DEFENDER_LEFT;
	mStrPlayerTypeMap["PT_MIDFIELDER_CENTER"] 	= PT_MIDFIELDER_CENTER;
	mStrPlayerTypeMap["PT_MIDFIELDER_RIGHT"] 	= PT_MIDFIELDER_RIGHT;
	mStrPlayerTypeMap["PT_MIDFIELDER_LEFT"] 	= PT_MIDFIELDER_LEFT;
	mStrPlayerTypeMap["PT_ATTACKER_LEFT"] 		= PT_ATTACKER_LEFT;
	mStrPlayerTypeMap["PT_ATTACKER_CENTRAL"] 	= PT_ATTACKER_CENTRAL;
	mStrPlayerTypeMap["PT_ATTACKER_RIGHT"] 		= PT_ATTACKER_RIGHT;
...
Formation::FormationData Formation::parseFormationData(const sexp_t* sexp) const throw(ClassException<Formation>)
{
    ...
    while(sexp)
    {
        if ( !parser::SexpParser::parseGivenValue(sexp,"robot",data.robot)
	     && !parser::SexpParser::parseGivenValue(sexp,"hetero",data.heteroType) /*this condotion add by yao for heteronao*/
    ...
    //cout<<"tt:"<<data.heteroType<<"\tnum:"<<data.type<<endl;
